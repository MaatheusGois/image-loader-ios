...
SDImageCoderOptions * _Nonnull SDGetDecodeOptionsFromContext(ImageLoaderContext * _Nullable context, ImageLoaderOptions options, NSString * _Nonnull cacheKey) {
...
void SDSetDecodeOptionsToContext(ImageLoaderMutableContext * _Nonnull mutableContext, ImageLoaderOptions * _Nonnull mutableOptions, SDImageCoderOptions * _Nonnull decodeOptions) {
    ...
    mutableContext[ImageLoaderContextImageScaleFactor] = decodeOptions[SDImageCoderDecodeScaleFactor];
    mutableContext[ImageLoaderContextImagePreserveAspectRatio] = decodeOptions[SDImageCoderDecodePreserveAspectRatio];
    mutableContext[ImageLoaderContextImageThumbnailPixelSize] = decodeOptions[SDImageCoderDecodeThumbnailPixelSize];
    mutableContext[ImageLoaderContextImageScaleDownLimitBytes] = decodeOptions[SDImageCoderDecodeScaleDownLimitBytes];
...
UIImage * _Nullable SDImageCacheDecodeImageData(NSData * _Nonnull imageData, NSString * _Nonnull cacheKey, ImageLoaderOptions options, ImageLoaderContext * _Nullable context) {
