...
typedef NSURLResponse * _Nullable (^ImageLoaderDownloaderResponseModifierBlock)(NSURLResponse * _Nonnull response);
 ...
 */
@protocol ImageLoaderDownloaderResponseModifier <NSObject>
...
/// @note If nil is returned, the image download will marked as cancelled with error `ImageLoaderErrorInvalidDownloadResponse`
 ...
 */
@interface ImageLoaderDownloaderResponseModifier : NSObject <ImageLoaderDownloaderResponseModifier>

/// Create the response modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull ImageLoaderDownloaderResponseModifierBlock)block;

/// Create the response modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)responseModifierWithBlock:(nonnull ImageLoaderDownloaderResponseModifierBlock)block;
...
*/
@interface ImageLoaderDownloaderResponseModifier (Conveniences)
