...
/**
 ...
 Coders
 ------
 A coder must conform to the `LoadImageCoder` protocol or even to `SDProgressiveImageCoder` if it supports progressive decoding
 ...
 */
@interface LoadImageCodersManager : NSObject <LoadImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) LoadImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<LoadImageCoder>> *coders;
