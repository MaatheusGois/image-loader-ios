 ...
 */
@property (nonatomic, strong, readonly, nullable) NSURL *btg_imageURL;
 ...
 * See more about this in `ImageLoaderContextSetImageOperationKey`.
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSString *btg_latestOperationKey;
 ...
 * The `totalUnitCount` and `completedUnitCount` will be reset to 0 after a new image loading start (change from current queue). And they will be set to `ImageLoaderProgressUnitCountUnknown` if the progressBlock not been called but the image loading success to mark the progress finished (change from main queue).
 ...
 */
@property (nonatomic, strong, null_resettable) NSProgress *btg_imageProgress;
 ...
 */
@property (nonatomic, strong, nullable) ImageLoaderTransition *btg_imageTransition;
 ...
 */
@property (nonatomic, strong, nullable) id<ImageLoaderIndicator> btg_imageIndicator;
