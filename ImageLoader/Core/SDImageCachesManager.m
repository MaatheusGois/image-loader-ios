...
- (id<ImageLoaderOperation>)queryImageForKey:(NSString *)key options:(ImageLoaderOptions)options context:(ImageLoaderContext *)context completion:(SDImageCacheQueryCompletionBlock)completionBlock {
...
- (id<ImageLoaderOperation>)queryImageForKey:(NSString *)key options:(ImageLoaderOptions)options context:(ImageLoaderContext *)context cacheType:(SDImageCacheType)cacheType completion:(SDImageCacheQueryCompletionBlock)completionBlock {
    if (!key) {
        return nil;
    }
...
- (void)storeImage:(UIImage *)image imageData:(NSData *)imageData forKey:(NSString *)key cacheType:(SDImageCacheType)cacheType completion:(ImageLoaderNoParamsBlock)completionBlock {
...
- (void)storeImage:(UIImage *)image imageData:(NSData *)imageData forKey:(NSString *)key options:(ImageLoaderOptions)options context:(ImageLoaderContext *)context cacheType:(SDImageCacheType)cacheType completion:(ImageLoaderNoParamsBlock)completionBlock {
    if (!key) {
        return;
    }
    NSArray<id<SDImageCache>> *caches = self.caches;
...
- (void)removeImageForKey:(NSString *)key cacheType:(SDImageCacheType)cacheType completion:(ImageLoaderNoParamsBlock)completionBlock {
    if (!key) {
        return;
    }
    NSArray<id<SDImageCache>> *caches = self.caches;
...
- (void)concurrentStoreImage:(UIImage *)image imageData:(NSData *)imageData forKey:(NSString *)key options:(ImageLoaderOptions)options context:(ImageLoaderContext *)context cacheType:(SDImageCacheType)cacheType completion:(ImageLoaderNoParamsBlock)completionBlock enumerator:(NSEnumerator<id<SDImageCache>> *)enumerator operation:(SDImageCachesManagerOperation *)operation {
    NSParameterAssert(enumerator);
    NSParameterAssert(operation);
    for (id<SDImageCache> cache in enumerator) {
...
- (void)concurrentRemoveImageForKey:(NSString *)key cacheType:(SDImageCacheType)cacheType completion:(ImageLoaderNoParamsBlock)completionBlock enumerator:(NSEnumerator<id<SDImageCache>> *)enumerator operation:(SDImageCachesManagerOperation *)operation {
    NSParameterAssert(enumerator);
    NSParameterAssert(operation);
    for (id<SDImageCache> cache in enumerator) {
...
- (void)concurrentClearWithCacheType:(SDImageCacheType)cacheType completion:(ImageLoaderNoParamsBlock)completionBlock enumerator:(NSEnumerator<id<SDImageCache>> *)enumerator operation:(SDImageCachesManagerOperation *)operation {
    NSParameterAssert(enumerator);
    NSParameterAssert(operation);
    for (id<SDImageCache> cache in enumerator) {
...
- (void)serialStoreImage:(UIImage *)image imageData:(NSData *)imageData forKey:(NSString *)key options:(ImageLoaderOptions)options context:(ImageLoaderContext *)context cacheType:(SDImageCacheType)cacheType completion:(ImageLoaderNoParamsBlock)completionBlock enumerator:(NSEnumerator<id<SDImageCache>> *)enumerator {
    NSParameterAssert(enumerator);
    id<SDImageCache> cache = enumerator.nextObject;
    if (!cache) {
        // Complete
...
- (void)serialRemoveImageForKey:(NSString *)key cacheType:(SDImageCacheType)cacheType completion:(ImageLoaderNoParamsBlock)completionBlock enumerator:(NSEnumerator<id<SDImageCache>> *)enumerator {
    NSParameterAssert(enumerator);
    id<SDImageCache> cache = enumerator.nextObject;
    if (!cache) {
        // Complete
...
- (void)serialClearWithCacheType:(SDImageCacheType)cacheType completion:(ImageLoaderNoParamsBlock)completionBlock enumerator:(NSEnumerator<id<SDImageCache>> *)enumerator {
    NSParameterAssert(enumerator);
    id<SDImageCache> cache = enumerator.nextObject;
    if (!cache) {
        // Complete
