...
/**
 ...
 For the description about these methods, see `ImageLoaderDownloaderOperation`
 ...
 */
@protocol ImageLoaderDownloaderOperation <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
@required
...
// These operation-level config was inherited from downloader. See `ImageLoaderDownloaderConfig` for documentation.
...
/**
 The download operation class for ImageLoaderDownloader.
 */
@interface ImageLoaderDownloaderOperation : NSOperation <ImageLoaderDownloaderOperation>
 ...
 */
@property (assign, nonatomic, readonly) ImageLoaderDownloaderOptions options;

/**
 * The context for the receiver.
 */
@property (copy, nonatomic, readonly, nullable) ImageLoaderContext *context;

/**
 *  Initializes a `ImageLoaderDownloaderOperation` object
 *
 *  @see ImageLoaderDownloaderOperation
 *
...
- (nonnull instancetype)initWithRequest:(nullable NSURLRequest *)request
                              inSession:(nullable NSURLSession *)session
                                options:(ImageLoaderDownloaderOptions)options
                                context:(nullable ImageLoaderContext *)context NS_DESIGNATED_INITIALIZER;
