 ...
 */
@interface LoadImageIOAnimatedCoder : NSObject <SDProgressiveImageCoder, SDAnimatedImageCoder>

#pragma mark - Subclass Override
/**
 The supported animated image format. Such as `LoadImageFormatGIF`.
 @note Subclass override.
 */
@property (class, readonly) LoadImageFormat imageFormat;
/**
 The supported image format UTI Type. Such as `kSDUTTypeGIF`.
 This can be used for cases when we can not detect `LoadImageFormat. Such as progressive decoding's hint format `kCGImageSourceTypeIdentifierHint`.
 @note Subclass override.
 */
