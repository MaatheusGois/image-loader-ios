...
/**
 ...
 You can provide transformer to cache and manager (Through the `transformer` property or context option `ImageLoaderContextImageTransformer`).
 
 @note The transform process is called from a global queue in order to not to block the main queue.
 */
@protocol LoadImageTransformer <NSObject>
 ...
 */
@interface LoadImagePipelineTransformer : NSObject <LoadImageTransformer>

/**
 All transformers in pipeline
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<id<LoadImageTransformer>> *transformers;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithTransformers:(nonnull NSArray<id<LoadImageTransformer>> *)transformers;
 ...
 */
@interface LoadImageRoundCornerTransformer: NSObject <LoadImageTransformer>
 ...
 */
@interface LoadImageResizingTransformer : NSObject <LoadImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) LoadImageScaleMode scaleMode;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithSize:(CGSize)size scaleMode:(LoadImageScaleMode)scaleMode;
 ...
 */
@interface LoadImageCroppingTransformer : NSObject <LoadImageTransformer>
 ...
 */
@interface LoadImageFlippingTransformer : NSObject <LoadImageTransformer>
 ...
 */
@interface LoadImageRotationTransformer : NSObject <LoadImageTransformer>
 ...
 */
@interface LoadImageTintTransformer : NSObject <LoadImageTransformer>
 ...
 */
@interface LoadImageBlurTransformer : NSObject <LoadImageTransformer>
 ...
 */
@interface LoadImageFilterTransformer: NSObject <LoadImageTransformer>
