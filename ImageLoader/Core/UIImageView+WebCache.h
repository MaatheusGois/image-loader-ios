...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Here we use the provided btg_setImageWithURL:placeholderImage: method to load the web image
    // Ensure you use a placeholder image otherwise cells will be initialized with no image
    [cell.imageView btg_setImageWithURL:[NSURL URLWithString:@"http://example.com/image.jpg"]
...
/**
 * Integrates ImageLoader async downloading and caching of remote images with UIImageView.
 */
