 ...
 */
FOUNDATION_EXPORT UIImage * _Nullable SDImageCacheDecodeImageData(NSData * _Nonnull imageData, NSString * _Nonnull cacheKey, ImageLoaderOptions options, ImageLoaderContext * _Nullable context);
...
/// @param options The options arg from the input
/// @param cacheKey The image cache key from the input. Should not be nil
FOUNDATION_EXPORT SDImageCoderOptions * _Nonnull SDGetDecodeOptionsFromContext(ImageLoaderContext * _Nullable context, ImageLoaderOptions options, NSString * _Nonnull cacheKey);
...
FOUNDATION_EXPORT void SDSetDecodeOptionsToContext(ImageLoaderMutableContext * _Nonnull mutableContext, ImageLoaderOptions * _Nonnull mutableOptions, SDImageCoderOptions * _Nonnull decodeOptions);
