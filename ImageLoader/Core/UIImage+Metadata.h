 ...
 */
@property (nonatomic, assign) NSUInteger _imageLoopCount;
 ...
 * Returns 1 for static image.
 */
@property (nonatomic, assign, readonly) NSUInteger _imageFrameCount;
 ...
 */
@property (nonatomic, assign, readonly) BOOL _isAnimated;
 ...
 */
@property (nonatomic, assign, readonly) BOOL _isVector;
 ...
 */
@property (nonatomic, assign) BOOL _isTransformed;
...
/**
 ...
 @note This just check `_decodeOptions[.decodeThumbnailPixelSize] > CGSize.zero`
 */
@property (nonatomic, assign, readonly) BOOL _isThumbnail;
 ...
 */
@property (nonatomic, copy) LoadImageCoderOptions *_decodeOptions;
